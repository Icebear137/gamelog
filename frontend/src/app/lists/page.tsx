  ...
  return (
    <div>
      <Flex align="center" justify="between" className="mb-5">
        <Heading size="6">My Lists</Heading>
      ...
      {isLoading ? (
        <Text as="p" size="2" color="gray">Loading...</Text>
      ) : lists.length === 0 ? (
        <div className="text-center py-20 text-gray-500">
          <List size={40} className="mx-auto mb-3 opacity-30" />
          <Text as="p" size="2" className="mb-1">No lists yet.</Text>
          <Text as="p" size="2">Create a list to organize your games.</Text>
        </div>
      ) : (
    ...
    >
      <div className="bg-white/5 backdrop-blur-sm border border-white/8 group-hover:border-violet-700 rounded-2xl overflow-hidden transition-colors">
        ...
        <div className="p-4">
          ...
          {list.description && (
            <Text as="p" size="1" color="gray" className="mt-1 line-clamp-2">{list.description}</Text>
          )}
